              ...
              onPressed: () {
                ...
                switch (_levelValue) {
                  case RadioLevel.level1:
                    if (isCheckFood == true) {
                      dispPics = dispPics + picFoodLevel1;
                      maxCardNum += 10;
                    }
                    if (isCheckAnimal == true) {
                      dispPics = dispPics + picAnimalLevel1;
                      maxCardNum += 10;
                    }
                    if (isCheckNorimono == true) {
                      dispPics = dispPics + picNorimonoLevel1;
                      maxCardNum += 10;
                    }
                    if (isCheckHito == true) {
                      dispPics = dispPics + picHitoLevel1;
                      maxCardNum += 10;
                    }
                    if (isCheckGoods == true) {
                      dispPics = dispPics + picGoodsLevel1;
                      maxCardNum += 10;
                    }
                    break;
                  case RadioLevel.level2:
                    if (isCheckFood == true) {
                      dispPics = dispPics + picFoodLevel2;
                      maxCardNum += 10;
                    }
                    if (isCheckAnimal == true) {
                      dispPics = dispPics + picAnimalLevel2;
                      maxCardNum += 10;
                    }
                    if (isCheckNorimono == true) {
                      dispPics = dispPics + picNorimonoLevel2;
                      maxCardNum += 10;
                    }
                    if (isCheckHito == true) {
                      dispPics = dispPics + picHitoLevel2;
                      maxCardNum += 10;
                    }
                    if (isCheckGoods == true) {
                      dispPics = dispPics + picGoodsLevel2;
                      maxCardNum += 10;
                    }
                    break;
                  default:
